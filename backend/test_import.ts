...
const bulkImportEmployees = async (rawEmployees: any[]) => {
  ...
  if (posError) {
    ...
    throw new Error(posError.message || 'Failed to create positions for bulk import');
  }
...
bulkImportEmployees([{
  emp_id: 'APS0060',
  full_name: 'Ranjit Kumar',
  email_official: 'test@123',
  designation: 'Senior Manager',
  department: 'Analytical Dev',
  sub_function: 'Routine',
  business_unit: 'R&D',
  ctc_annual: '1000000'
